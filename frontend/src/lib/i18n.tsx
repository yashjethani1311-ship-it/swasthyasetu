...
const translations = {
    English: {
        ...
        nav: {
            ...
            copilot: 'AI Copilot'
            ,adminGovernance: 'Governance Console'
        },
    ...
    Hindi: {
        ...
        nav: {
            dashboard: 'मुख्य पेज',
            consent: 'जानकारी साझा करना',
            care: 'इलाज का सफर',
            followUp: 'दोबारा हाल जानना',
            appointments: 'डॉक्टर से मिलने का समय',
            records: 'मेरी मेडिकल रिपोर्ट',
            prescriptions: 'डॉक्टर की पर्ची',
            diagnostics: 'जाँच / टेस्ट',
            pharmacy: 'फार्मेसी ERP / POS',
            medicines: 'मेरी दवाइयाँ',
            insurance: 'बीमा / योजनाएँ',
            facilities: 'अस्पताल / क्लिनिक',
            doctors: 'डॉक्टर खोजें',
            buyRefill: 'दवा खरीदें / दोबारा मँगाएँ',
            healthAi: 'स्वास्थ्य एआई',
            sos: 'आपातकाल / SOS',
            encounter: 'मरीज परामर्श',
            opdQueue: 'ओपीडी कतार',
            commandCentre: 'कमांड सेंटर',
            reception: 'रिसेप्शन डेस्क',
            patients: 'रोगी सूची',
            departments: 'विभाग',
            staff: 'डॉक्टर और स्टाफ',
            schedules: 'ड्यूटी रोस्टर',
            beds: 'बेड और वार्ड (ADT)',
            ipd: 'भर्ती मरीज (IPD)',
            emergency: 'आपातकालीन वार्ड',
            billing: 'बिलिंग और काउंटर',
            inventory: 'दवा व सामग्री भंडार',
            referrals: 'रेफरल सेवाएँ',
            reports: 'प्रबंधन रिपोर्ट (MIS)',
            integrations: 'ABDM इंटीग्रेशन',
            copilot: 'एआई स्वास्थ्य सहायक'
            ,adminGovernance: 'गवर्नेंस कंसोल'
        },

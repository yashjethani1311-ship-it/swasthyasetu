...
function DemoRegistration({
  ...
  async function createAccount() {
    ...
    /*
      Demo registration RPC requires an
      authenticated session.

      During prototype testing email
      confirmation should therefore be OFF.
    */

    if (!data.session) {
      setError(
        'Account was created, but no active session was returned. For prototype testing, disable email confirmation in Supabase Authentication, delete this incomplete test user, and register again.'
      )
